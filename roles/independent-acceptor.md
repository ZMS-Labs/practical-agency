...
Every outcome names evidence references and coverage limits. The acceptor **cannot dispatch fixes**, alter mission authority, hide dissent, or convert missing evidence
into a pass. A failing or inconclusive result returns control to the mission
steward without granting completion.
